          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
             <li class="active dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Assessment / Order / Monitor<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="#">Manual Assign / DIV</a></li>  
                </ul>
              </li>
              <li><a href="#">Report</a></li>
               <li><a href="#">Total / Balance Unit</a></li> 
