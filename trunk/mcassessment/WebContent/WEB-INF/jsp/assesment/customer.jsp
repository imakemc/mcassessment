		...
		<div class="container" style="background-color:#fff; box-shadow: 0px 5px 10px #3e4545; margin-bottom: 20px;">
			<div class="row">
	  			<div class="col-md-8 col-md-offset-2" style=" background: #ffffff; margin-top: 30px; min-height: 400px;">
	     			<a href="file:///root/Desktop/mcs/WebContent/Add_Customer.html#"><button type="button" class="btn btn-info" style="margin-bottom: 5px;"><span class="glyphicon glyphicon-plus"></span> Add </button></a>
		     			...
		     			<table class="table tb table-hover">
			     			<tbody>
				     			...
				     			<tr>
				     				...
				     				<td class="col-md-8" style="padding-left: 30px; vertical-align: middle;">Neptune Food and Beverage Co.,Ltd</td>
				     				<td class="col-md-2" style="text-align: center;">
			     						<a href="file:///root/Desktop/mcs/WebContent/Add_Customer.html#"><button class="btn btn-success btn-flat btn"><i class="glyphicon glyphicon-edit"></i></button></a>
			     				...
			     				<tr>
				     				...
				     				<td class="col-md-8" style="padding-left: 30px; vertical-align: middle;">gooooooooogle cooperation</td>
				     				<td class="col-md-2" style="text-align: center;">
			     						<a href="file:///root/Desktop/mcs/WebContent/Add_Customer.html#"><button class="btn btn-success btn-flat btn"><i class="glyphicon glyphicon-edit"></i></button></a>
									  	<button class="btn btn-danger btn-flat btn" data-toggle="modal" data-target="#delete-popup"><i class="glyphicon glyphicon-trash"></i> </button>
				     				</td>
			     				...
			     				<tr>
				     				...
				     				<td class="col-md-8" style="padding-left: 30px; vertical-align: middle;">Albatross Consulting Co.,Ltd</td>
				     				<td class="col-md-2" style="text-align: center;">
			     						<a href="file:///root/Desktop/mcs/WebContent/Add_Customer.html#"><button class="btn btn-success btn-flat btn"><i class="glyphicon glyphicon-edit"></i></button></a>
									  	<button class="btn btn-danger btn-flat btn" data-toggle="modal" data-target="#delete-popup"><i class="glyphicon glyphicon-trash"></i> </button>
				     				</td>
			     				...
			     				<tr>
				     				...
				     				<td class="col-md-8" style="padding-left: 30px; vertical-align: middle;">Robinson store & Market</td>
				     				<td class="col-md-2" style="text-align: center;">
			     						<a href="file:///root/Desktop/mcs/WebContent/Add_Customer.html#"><button class="btn btn-success btn-flat btn"><i class="glyphicon glyphicon-edit"></i></button></a>
									  	<button class="btn btn-danger btn-flat btn" data-toggle="modal" data-target="#delete-popup"><i class="glyphicon glyphicon-trash"></i> </button>
				     				</td>
			     				...
			     				<tr>
				     				...
				     				<td class="col-md-8" style="padding-left: 30px; vertical-align: middle;">Microsoft coop</td>
				     				<td class="col-md-2" style="text-align: center;">
			     						<a href="file:///root/Desktop/mcs/WebContent/Add_Customer.html#"><button class="btn btn-success btn-flat btn"><i class="glyphicon glyphicon-edit"></i></button></a>
									  	<button class="btn btn-danger btn-flat" data-toggle="modal" data-target="#delete-popup"><i class="glyphicon glyphicon-trash"></i> </button>
				     				</td>
			     				</tr>
		     				</tbody>
		     			</table>
