...
<html lang="en">
  ...
  <link href="<c:url value='/resources/bootstrap2.3.2/css/bootstrap-responsive.css'/>" rel="stylesheet"  media="all" type="text/css"/>  
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">MC Assessment</a>
          <div class="nav-collapse collapse">
            <ul class="nav"> 
              <li class="active dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">do Assesment <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="#">Assesment 1 </a></li>
                   <li><a href="#">Assesment 2 </a></li> 
                  <li><a href="#">Assesment 3 </a></li>
                </ul>
              </li> 
